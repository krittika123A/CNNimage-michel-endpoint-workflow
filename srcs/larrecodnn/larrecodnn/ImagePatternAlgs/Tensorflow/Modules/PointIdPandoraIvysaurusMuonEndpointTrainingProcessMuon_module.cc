////////////////////////////////////////////////////////////////////////////////////////////////////
// Class:       PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon
//
...
namespace {
  ...
  // Michel wins over muon, EM, and other truth in a mixed hit.
  ...
  struct HitTruth {
    ...
    float michelElectronEnergyGeV = -1.F;
    float michelElectronKineticEnergyGeV = -1.F;
    double muonCharge = 0.0;
    bool ambiguous = false;
    float michelElectronEndEnergyGeV = -1.F;
  ...
  struct EndpointTruth {
    ...
    // Per-plane quantities make W-only labels auditable.
    std::array<int, kNPlanes> planeHits{{0, 0, 0}};
    std::array<int, kNPlanes> planeMichelHits{{0, 0, 0}};
    std::array<int, kNPlanes> planeMichelPixels{{0, 0, 0}};
    std::array<int, kNPlanes> planeHasMichel{{0, 0, 0}};
    std::array<int, kNPlanes> planeImageValid{{0, 0, 0}};
    std::array<double, kNPlanes> planeMichelCharge{{0.0, 0.0, 0.0}};
    std::array<double, kNPlanes> planeMuonCharge{{0.0, 0.0, 0.0}};
    std::array<double, kNPlanes> planeMichelDepositEnergyMeV{{0.0, 0.0, 0.0}};
    std::array<double, kNPlanes> planeBestMichelCharge{{0.0, 0.0, 0.0}};
    std::array<float, kNPlanes> planeMichelElectronEnergyGeV{{-1.F, -1.F, -1.F}};
    std::array<float, kNPlanes> planeMichelElectronKineticEnergyGeV{{-1.F, -1.F, -1.F}};
    std::array<float, kNPlanes> planeMichelElectronEndEnergyGeV{{-1.F, -1.F, -1.F}};
  };
...
namespace nnet {
  ...
  class PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon : public art::EDAnalyzer {
  public:
    struct Config {
      ...
      fhicl::Sequence<std::string> MichelElectronProcesses{
        ...
        Comment("MCParticle Process() values accepted for Michel electrons"),
        std::vector<std::string>{"Decay", "DecayWithSpin"}
      };
      fhicl::Sequence<std::string> MichelMuonEndProcesses{
        Name("MichelMuonEndProcesses"),
        Comment("MCParticle EndProcess() values accepted for Michel muon parents"),
        std::vector<std::string>{"Decay", "DecayWithSpin", "FastScintillation"}
      };
      fhicl::Atom<int> MuonPdgCode{Name("MuonPdgCode"), Comment("Absolute Pandora PFParticle PDG used for muon selection"), 13};
      fhicl::Atom<bool> RequireMuonPandoraPdg{Name("RequireMuonPandoraPdg"), Comment("Keep only Pandora PFParticles with the configured muon PDG"), true};
      fhicl::Atom<bool> RequireContainedTrack{Name("RequireContainedTrack"), Comment("Require both reconstructed endpoints inside the active TPC"), true};
      fhicl::Atom<float> ContainmentMargin{Name("ContainmentMargin"), Comment("Symmetric active-volume containment margin in cm"), 0.F};
    ...
    explicit PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon(Parameters const& config);
  ...
  private:
    ...
    bool acceptsProcess(std::vector<std::string> const& processes,
                        std::string const& process) const;
    bool endpointContained(TVector3 const& point, int cryo, int tpc) const;
    bool isMichelElectronFromProcess(
      simb::MCParticle const& particle,
      std::unordered_map<int, simb::MCParticle const*> const& particleMap,
      int& muonTrackId,
      int& muonPdg,
      std::string& muonProcess,
      std::string& muonEndProcess) const;
    ...
    float b_startMichelElectronEnergyGeV = -1.F;
    float b_endMichelElectronEnergyGeV = -1.F;
    float b_startMichelElectronKineticEnergyGeV = -1.F;
    float b_endMichelElectronKineticEnergyGeV = -1.F;
    float b_startMichelElectronEndEnergyGeV = -1.F;
    float b_endMichelElectronEndEnergyGeV = -1.F;
    ...
    float b_startMichelChargeFraction = 0.F;
    float b_endMichelChargeFraction = 0.F;
    int b_startMichelAmbiguousHits = 0;
    int b_endMichelAmbiguousHits = 0;
    ...
    int b_startMichelHitsW = 0;
    int b_endMichelHitsW = 0;
    int b_startMichelPixelsW = 0;
    int b_endMichelPixelsW = 0;
    float b_startMichelChargeW = 0.F;
    float b_endMichelChargeW = 0.F;
    float b_startMichelChargeFractionW = 0.F;
    float b_endMichelChargeFractionW = 0.F;
    float b_startMichelDepositEnergyWMeV = 0.F;
    float b_endMichelDepositEnergyWMeV = 0.F;
    float b_startMichelElectronEnergyWGeV = -1.F;
    float b_endMichelElectronEnergyWGeV = -1.F;
    float b_startMichelElectronKineticEnergyWGeV = -1.F;
    float b_endMichelElectronKineticEnergyWGeV = -1.F;
    float b_startMichelElectronEndEnergyWGeV = -1.F;
    float b_endMichelElectronEndEnergyWGeV = -1.F;
  ...
  //-----------------------------------------------------------------------
  PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon(
    Parameters const& config)
    : art::EDAnalyzer(config)
    , fMichelElectronProcesses(config().MichelElectronProcesses())
    , fMichelMuonEndProcesses(config().MichelMuonEndProcesses())
    , fMuonPdgCode(config().MuonPdgCode())
    , fRequireMuonPandoraPdg(config().RequireMuonPandoraPdg())
  ...
  //-----------------------------------------------------------------------
  void PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::beginJob()
  {
    ...
    fTree->Branch("StartMichelElectronEnergyGeV", &b_startMichelElectronEnergyGeV, "StartMichelElectronEnergyGeV/F");
    fTree->Branch("EndMichelElectronEnergyGeV", &b_endMichelElectronEnergyGeV, "EndMichelElectronEnergyGeV/F");
    fTree->Branch("StartMichelElectronKineticEnergyGeV", &b_startMichelElectronKineticEnergyGeV, "StartMichelElectronKineticEnergyGeV/F");
    fTree->Branch("EndMichelElectronKineticEnergyGeV", &b_endMichelElectronKineticEnergyGeV, "EndMichelElectronKineticEnergyGeV/F");
    fTree->Branch("StartMichelElectronEndEnergyGeV", &b_startMichelElectronEndEnergyGeV, "StartMichelElectronEndEnergyGeV/F");
    fTree->Branch("EndMichelElectronEndEnergyGeV", &b_endMichelElectronEndEnergyGeV, "EndMichelElectronEndEnergyGeV/F");
    ...
    fTree->Branch("StartMichelChargeFraction", &b_startMichelChargeFraction, "StartMichelChargeFraction/F");
    fTree->Branch("EndMichelChargeFraction", &b_endMichelChargeFraction, "EndMichelChargeFraction/F");
    fTree->Branch("StartMichelAmbiguousHits", &b_startMichelAmbiguousHits, "StartMichelAmbiguousHits/I");
    fTree->Branch("EndMichelAmbiguousHits", &b_endMichelAmbiguousHits, "EndMichelAmbiguousHits/I");
    ...
    fTree->Branch("StartWHits", &b_startWHits, "StartWHits/I");
    fTree->Branch("EndWHits", &b_endWHits, "EndWHits/I");
    ...
    fTree->Branch("StartMichelHitsW", &b_startMichelHitsW, "StartMichelHitsW/I");
    fTree->Branch("EndMichelHitsW", &b_endMichelHitsW, "EndMichelHitsW/I");
    fTree->Branch("StartMichelPixelsW", &b_startMichelPixelsW, "StartMichelPixelsW/I");
    fTree->Branch("EndMichelPixelsW", &b_endMichelPixelsW, "EndMichelPixelsW/I");
    fTree->Branch("StartMichelChargeW", &b_startMichelChargeW, "StartMichelChargeW/F");
    fTree->Branch("EndMichelChargeW", &b_endMichelChargeW, "EndMichelChargeW/F");
    fTree->Branch("StartMichelChargeFractionW", &b_startMichelChargeFractionW, "StartMichelChargeFractionW/F");
    fTree->Branch("EndMichelChargeFractionW", &b_endMichelChargeFractionW, "EndMichelChargeFractionW/F");
    fTree->Branch("StartMichelDepositEnergyWMeV", &b_startMichelDepositEnergyWMeV, "StartMichelDepositEnergyWMeV/F");
    fTree->Branch("EndMichelDepositEnergyWMeV", &b_endMichelDepositEnergyWMeV, "EndMichelDepositEnergyWMeV/F");
    fTree->Branch("StartMichelElectronEnergyWGeV", &b_startMichelElectronEnergyWGeV, "StartMichelElectronEnergyWGeV/F");
    fTree->Branch("EndMichelElectronEnergyWGeV", &b_endMichelElectronEnergyWGeV, "EndMichelElectronEnergyWGeV/F");
    fTree->Branch("StartMichelElectronKineticEnergyWGeV", &b_startMichelElectronKineticEnergyWGeV, "StartMichelElectronKineticEnergyWGeV/F");
    fTree->Branch("EndMichelElectronKineticEnergyWGeV", &b_endMichelElectronKineticEnergyWGeV, "EndMichelElectronKineticEnergyWGeV/F");
    fTree->Branch("StartMichelElectronEndEnergyWGeV", &b_startMichelElectronEndEnergyWGeV, "StartMichelElectronEndEnergyWGeV/F");
    fTree->Branch("EndMichelElectronEndEnergyWGeV", &b_endMichelElectronEndEnergyWGeV, "EndMichelElectronEndEnergyWGeV/F");
  ...
  //-----------------------------------------------------------------------
  void PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::analyze(art::Event const& event)
  {
    ...
    for (std::size_t iPfp = 0; iPfp < pfpHandle->size(); ++iPfp) {
      ...
      if (fRequireMuonPandoraPdg && std::abs(pfp.PdgCode()) != fMuonPdgCode) continue;
      ...
      if (fRequireContainedTrack &&
          (!endpointContained(TVector3(start.xyz[0], start.xyz[1], start.xyz[2]), domTPC.cryo, domTPC.tpc) ||
           !endpointContained(TVector3(end.xyz[0], end.xyz[1], end.xyz[2]), domTPC.cryo, domTPC.tpc))) continue;
      ...
      b_startMichelElectronEnergyGeV = startTruth.michelElectronEnergyGeV;
      b_endMichelElectronEnergyGeV = endTruth.michelElectronEnergyGeV;
      b_startMichelElectronKineticEnergyGeV = startTruth.michelElectronKineticEnergyGeV;
      b_endMichelElectronKineticEnergyGeV = endTruth.michelElectronKineticEnergyGeV;
      b_startMichelElectronEndEnergyGeV = startTruth.michelElectronEndEnergyGeV;
      b_endMichelElectronEndEnergyGeV = endTruth.michelElectronEndEnergyGeV;
      ...
      b_startMichelChargeFraction = (startTruth.michelCharge + startTruth.muonCharge > 0.0)
                                      ? static_cast<float>(startTruth.michelCharge / (startTruth.michelCharge + startTruth.muonCharge))
                                      : 0.F;
      b_endMichelChargeFraction = (endTruth.michelCharge + endTruth.muonCharge > 0.0)
                                    ? static_cast<float>(endTruth.michelCharge / (endTruth.michelCharge + endTruth.muonCharge))
                                    : 0.F;
      b_startMichelAmbiguousHits = startTruth.ambiguousHits;
      b_endMichelAmbiguousHits = endTruth.ambiguousHits;
      b_endMichelMuonTrackId = endTruth.michelMuonTrackId;
      ...
      constexpr unsigned int wPlane = 2U;
      b_startWImageValid = startTruth.planeImageValid[wPlane];
      b_endWImageValid = endTruth.planeImageValid[wPlane];
      b_startWHits = startTruth.planeHits[wPlane];
      b_endWHits = endTruth.planeHits[wPlane];
      b_startHasMichelW = startTruth.planeHasMichel[wPlane];
      b_endHasMichelW = endTruth.planeHasMichel[wPlane];
      b_startMichelHitsW = startTruth.planeMichelHits[wPlane];
      b_endMichelHitsW = endTruth.planeMichelHits[wPlane];
      b_startMichelPixelsW = startTruth.planeMichelPixels[wPlane];
      b_endMichelPixelsW = endTruth.planeMichelPixels[wPlane];
      b_startMichelChargeW = static_cast<float>(startTruth.planeMichelCharge[wPlane]);
      b_endMichelChargeW = static_cast<float>(endTruth.planeMichelCharge[wPlane]);
      b_startMichelChargeFractionW =
        (startTruth.planeMichelCharge[wPlane] + startTruth.planeMuonCharge[wPlane] > 0.0)
          ? static_cast<float>(startTruth.planeMichelCharge[wPlane] /
                               (startTruth.planeMichelCharge[wPlane] + startTruth.planeMuonCharge[wPlane]))
          : 0.F;
      b_endMichelChargeFractionW =
        (endTruth.planeMichelCharge[wPlane] + endTruth.planeMuonCharge[wPlane] > 0.0)
          ? static_cast<float>(endTruth.planeMichelCharge[wPlane] /
                               (endTruth.planeMichelCharge[wPlane] + endTruth.planeMuonCharge[wPlane]))
          : 0.F;
      b_startMichelDepositEnergyWMeV = static_cast<float>(startTruth.planeMichelDepositEnergyMeV[wPlane]);
      b_endMichelDepositEnergyWMeV = static_cast<float>(endTruth.planeMichelDepositEnergyMeV[wPlane]);
      b_startMichelElectronEnergyWGeV = startTruth.planeMichelElectronEnergyGeV[wPlane];
      b_endMichelElectronEnergyWGeV = endTruth.planeMichelElectronEnergyGeV[wPlane];
      b_startMichelElectronKineticEnergyWGeV = startTruth.planeMichelElectronKineticEnergyGeV[wPlane];
      b_endMichelElectronKineticEnergyWGeV = endTruth.planeMichelElectronKineticEnergyGeV[wPlane];
      b_startMichelElectronEndEnergyWGeV = startTruth.planeMichelElectronEndEnergyGeV[wPlane];
      b_endMichelElectronEndEnergyWGeV = endTruth.planeMichelElectronEndEnergyGeV[wPlane];
  ...
  //-----------------------------------------------------------------------
  DominantTPC PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::dominantTPC(
  ...
  //-----------------------------------------------------------------------
  EndpointProjection PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::projectEndpoint(
  ...
  //-----------------------------------------------------------------------
  HitTruth PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::classifyHit(
    ...
    std::unordered_map<int, simb::MCParticle const*> const& particleMap) const
  {
    ...
    for (auto const& channel : simChannels) {
      ...
      for (auto const& timeSlice : channel.TDCIDEMap()) {
        ...
        for (auto const& energyDeposit : timeSlice.second) {
          ...
          // Require both MCParticle decay ancestry and Geant4 process metadata.
          if (isMichelElectronFromAncestry(particle, particleMap, muonTrackId, muonPdg) &&
              isMichelElectronFromProcess(particle,
                                           particleMap,
                                           muonTrackId,
                                           muonPdg,
                                           muonProcess,
            ...
            truth.michelMuonProcess = muonProcess;
            truth.michelMuonEndProcess = muonEndProcess;
            truth.michelCharge += charge;
            truth.michelDepositEnergyMeV += energyDeposit.energy;
            if (charge > bestMichelCharge) {
              ...
              truth.michelElectronEnergyGeV = static_cast<float>(particle.E());
              truth.michelElectronKineticEnergyGeV =
                std::max(0.F, static_cast<float>(particle.E() - particle.Mass()));
              truth.michelElectronEndEnergyGeV = static_cast<float>(particle.EndE());
    ...
    truth.ambiguous = (truth.michelCharge > 0.0 && truth.muonCharge > 0.0);
  ...
  //-----------------------------------------------------------------------
  void PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::fillEndpoint(
    ...
    EndpointTruth& truth) const
  {
    ...
    for (auto const& hit : hits) {
      ...
      truth.muonCharge += hitTruth.muonCharge;
      truth.planeMichelCharge[plane] += hitTruth.michelCharge;
      truth.planeMichelDepositEnergyMeV[plane] += hitTruth.michelDepositEnergyMeV;
      truth.planeMuonCharge[plane] += hitTruth.muonCharge;
      if (hitTruth.ambiguous) ++truth.ambiguousHits;
      // Store metadata from the highest-charge Michel contributor; sums remain separate.
      if (hitTruth.truthCode == kTruthMichel && hitTruth.michelCharge > truth.bestMichelCharge) {
        ...
        truth.michelElectronEnergyGeV = hitTruth.michelElectronEnergyGeV;
        truth.michelElectronKineticEnergyGeV = hitTruth.michelElectronKineticEnergyGeV;
        truth.michelElectronEndEnergyGeV = hitTruth.michelElectronEndEnergyGeV;
      ...
      if (hitTruth.truthCode == kTruthMichel &&
          hitTruth.michelCharge > truth.planeBestMichelCharge[plane]) {
        truth.planeBestMichelCharge[plane] = hitTruth.michelCharge;
        truth.planeMichelElectronEnergyGeV[plane] = hitTruth.michelElectronEnergyGeV;
        truth.planeMichelElectronKineticEnergyGeV[plane] = hitTruth.michelElectronKineticEnergyGeV;
        truth.planeMichelElectronEndEnergyGeV[plane] = hitTruth.michelElectronEndEnergyGeV;
      }
      truthGrids[plane][index] = mergeTruthCodes(truthGrids[plane][index], hitTruth.truthCode);
    ...
    for (unsigned int plane = 0; plane < kNPlanes; ++plane) {
      ...
      int michelPixels = 0;
      for (std::size_t index = 0; index < grids[plane].size(); ++index) {
        if (grids[plane][index] > 0.0F) hasCharge = true;
        if (truthGrids[plane][index] == kTruthMichel) ++michelPixels;
      }
      truth.planeMichelPixels[plane] = michelPixels;
      truth.planeImageValid[plane] = hasCharge ? 1 : 0;
      float const planeMichelFraction =
        (truth.planeHits[plane] > 0)
          ? static_cast<float>(truth.planeMichelHits[plane]) / static_cast<float>(truth.planeHits[plane])
          : 0.F;
      truth.planeHasMichel[plane] =
        (truth.planeMichelHits[plane] >= fMinMichelHits &&
         planeMichelFraction >= fMinMichelFraction) ? 1 : 0;
    }
  }

  //-----------------------------------------------------------------------
  std::vector<art::Ptr<recob::Hit>> PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::collectEventHits(
    art::Event const& event,
    std::vector<recob::Track> const& tracks,
    art::FindManyP<recob::Hit> const& trackHitAssoc) const
  {
    ...
    mf::LogWarning("PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon")
  ...
  //-----------------------------------------------------------------------
  bool PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::selected(
  ...
  //-----------------------------------------------------------------------
  void PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::writeEndpointPatchHists(
    art::Event const& event,
    int pfpKey,
    int trackKey,
    int cryo,
  ...
  //-----------------------------------------------------------------------
  void PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::writeEventDisplays(
    art::Event const& event,
    detinfo::DetectorClocksData const& clockData,
    std::vector<art::Ptr<recob::Hit>> const& eventHits,
    std::vector<sim::SimChannel> const& simChannels,
    ...
    for (auto const& entry : boundsByDisplay) {
      ...
      for (auto const& hit : eventHits) {
        ...
        if (truthHist) {
          ...
          truthHist->SetBinContent(bin, mergeTruthCodes(currentTruth, hitTruth.truthCode));
        }
      }
    }
  }
  ...
  //-----------------------------------------------------------------------
  bool PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::isMuonDecayAncestor(
    simb::MCParticle const& particle,
    std::unordered_map<int, simb::MCParticle const*> const& particleMap) const
  {
  ...
  //-----------------------------------------------------------------------
  bool PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::isMichelElectronFromAncestry(
    simb::MCParticle const& particle,
    std::unordered_map<int, simb::MCParticle const*> const& particleMap,
    int& muonTrackId,
    int& muonPdg) const
  ...
  //-----------------------------------------------------------------------
  bool PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::acceptsProcess(
    std::vector<std::string> const& processes, std::string const& process) const
  {
    return std::find(processes.begin(), processes.end(), process) != processes.end();
  }
  bool PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::isMichelElectronFromProcess(
    simb::MCParticle const& particle,
    std::unordered_map<int, simb::MCParticle const*> const& particleMap,
    int& muonTrackId,
    int& muonPdg,
    ...
    std::string& muonEndProcess) const
  {
    ...
    muonPdg = 0;
    muonProcess.clear();
    muonEndProcess.clear();
    if (std::abs(particle.PdgCode()) != 11) return false;
    if (!acceptsProcess(fMichelElectronProcesses, particle.Process())) return false;

    int motherTrackId = particle.Mother();
    auto motherSearch = particleMap.find(motherTrackId);
    if (motherSearch == particleMap.end()) motherSearch = particleMap.find(std::abs(motherTrackId));
    if (motherSearch == particleMap.end()) return false;

    simb::MCParticle const& mother = *(motherSearch->second);
    if (std::abs(mother.PdgCode()) != 13) return false;
    if (!acceptsProcess(fMichelMuonEndProcesses, mother.EndProcess())) return false;

    muonTrackId = mother.TrackId();
    muonPdg = mother.PdgCode();
    muonProcess = mother.Process();
    muonEndProcess = mother.EndProcess();
    return true;
  }
  // Keep both reconstructed endpoints inside the active TPC box.
  bool PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::endpointContained(
    TVector3 const& point, int cryo, int tpc) const
  {
    art::ServiceHandle<geo::Geometry const> geom;
    auto const& tpcGeo = geom->TPC(geo::TPCID{static_cast<unsigned int>(cryo), static_cast<unsigned int>(tpc)});
    auto const& active = tpcGeo.ActiveBoundingBox();
    return active.InFiducialX(point.X(), fContainmentMargin) && active.InFiducialY(point.Y(), fContainmentMargin) && active.InFiducialZ(point.Z(), fContainmentMargin);
  }
  void PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::resetBranches()
  {
    b_pfpKey = -1;
    b_pfpSelf = 0;
    b_startMichelElectronTrackId = 0;
    b_endMichelElectronTrackId = 0;
    b_startMichelElectronPdg = 0;
    b_endMichelElectronPdg = 0;
    b_startMichelElectronEnergyGeV = -1.F;
    b_endMichelElectronEnergyGeV = -1.F;
    b_startMichelElectronKineticEnergyGeV = -1.F;
    b_endMichelElectronKineticEnergyGeV = -1.F;
    b_startMichelElectronEndEnergyGeV = -1.F;
    b_endMichelElectronEndEnergyGeV = -1.F;
    b_startMichelDepositEnergyMeV = 0.F;
    b_endMichelDepositEnergyMeV = 0.F;
    b_startMichelCharge = 0.F;
    b_endMichelCharge = 0.F;
    b_startMichelChargeFraction = 0.F;
    b_endMichelChargeFraction = 0.F;
    b_startMichelAmbiguousHits = 0;
    b_endMichelAmbiguousHits = 0;
    ...
    b_startWImageValid = 0;
    b_endWImageValid = 0;
    b_startWHits = 0;
    b_endWHits = 0;
    b_startHasMichelW = 0;
    b_endHasMichelW = 0;
    b_startMichelHitsW = 0;
    b_endMichelHitsW = 0;
    b_startMichelPixelsW = 0;
    b_endMichelPixelsW = 0;
    b_startMichelChargeW = 0.F;
    b_endMichelChargeW = 0.F;
    b_startMichelChargeFractionW = 0.F;
    b_endMichelChargeFractionW = 0.F;
    b_startMichelDepositEnergyWMeV = 0.F;
    b_endMichelDepositEnergyWMeV = 0.F;
    b_startMichelElectronEnergyWGeV = -1.F;
    b_endMichelElectronEnergyWGeV = -1.F;
    b_startMichelElectronKineticEnergyWGeV = -1.F;
    b_endMichelElectronKineticEnergyWGeV = -1.F;
    b_startMichelElectronEndEnergyWGeV = -1.F;
    b_endMichelElectronEndEnergyWGeV = -1.F;
    b_pfpPdg = 0;
    b_trackKey = -1;
    b_cryo = -1;
    b_tpc = -1;
  ...
  //-----------------------------------------------------------------------
  void PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon::resetGridVectors()
  {
  ...
  DEFINE_ART_MODULE(PointIdPandoraIvysaurusMuonEndpointTrainingProcessMuon)
